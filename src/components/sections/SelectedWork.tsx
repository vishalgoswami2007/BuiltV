...
function ProjectVisual({
  ...
  return (
    <div className="relative flex aspect-video items-center justify-center overflow-hidden bg-[#0B1017] p-4 sm:p-8 lg:min-h-96 lg:aspect-auto">
      <div
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold leading-tight tracking-tight text-white sm:mt-5 sm:text-5xl">
              {t("selectedWork.titleStart")}{" "}
              <span className="text-slate-400">
                {t("selectedWork.titleHighlight")}
              </span>
            </h2>
          </div>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              >
                <ProjectVisual
                  title={project.title}
                  panelLabel={t(`selectedWork.${project.key}.panelLabel`)}
                ...
                <div className="flex flex-col justify-between p-5 sm:p-8 lg:p-12">
                  <div>
                    <p className="text-xs font-medium uppercase tracking-widest text-sky-300">
                      {t(`selectedWork.${project.key}.category`)}
                    </p>
                    ...
                    <p className="mt-4 max-w-lg text-sm leading-7 text-slate-400 sm:mt-5 sm:text-base">
                      {t(`selectedWork.${project.key}.description`)}
                    </p>
